...
**PhantomGuard v0.1.3** is a deterministic, terminal-first dependency verifier for Git repositories. It protects the commit boundary from hallucinated or mistyped public dependencies without executing scanned code, package managers, or an AI model.

The project ships a single Go binary with a command-line interface, a functional terminal workspace (TUI), and a Git pre-commit hook. The former browser dashboard and frontend are intentionally not part of this release.
...
## Codex event work record

PhantomGuard was developed during the Codex event across distinct work threads in two project directories. The `/feedback` identifier submitted for evaluation covers the core development work. The following supplementary session IDs provide the full team-work record:

- `019f664d-df4f-7420-b388-3ad284be2c96`
- `019f6ba4-3e86-7011-a1d5-abe05c1013ee`
- `019f6d0a-3f4d-7e12-88ae-3b70c6e3a1a1`
- `019f6dfb-aa36-75a1-b021-eff57094d627`
- `019f70c9-5dfe-76a3-a33c-a1f45ac68ee9`
- `019f8153-5ac9-7431-aa9d-f09025c41df3`
